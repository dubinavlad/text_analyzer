...
#Запускает специфический процессор с OrganizationAnalyzer, разбивает текст на токены  из которых мы получаем названия организаций и государственных установ а также номер токена в тексте , как Agents и Agents_number
class Organization:
