...
#Запускает специфический процессор с KeywordAnalyzer, разбивает текст на токены  в которых мы ищем ключевые слова "пункт" "статья" , а также номера статей и пунктов
class Point:
